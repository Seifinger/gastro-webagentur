...
Archetyp **Traditionell** · Schema **hell** · Designsystem `indisch--gewuerzmarkt` (maschinenlesbar: `indisch--gewuerzmarkt.json`)

> Gewürzmarkt: Kurkuma, Messing, Bombay-Café – schmal, warm, belebt.

## Referenzen

- **[Dishoom](https://www.dishoom.com)** (Restaurant) – übernommen: warmer Papiergrund; Serife + Versal-Rubriken; Geschichten neben der Karte · bewusst nicht: Illustrations-Overload
- **[Hoppers](https://www.hopperslondon.com)** (Restaurant) – übernommen: ein kräftiger Akzent; direkte Sprache · bewusst nicht: Mehrfarb-Illustration
- **[Hungry Tiger](https://styles.refero.design/style/47f15da7-8905-45b3-bcab-06a4277c6168)** (Refero-Style) – übernommen: Gold-auf-Rost-Palette; Headline als Marktschild · bewusst nicht: Graffiti-Texturen

Referenz-Signal: Temperatur **warm**, Helligkeit **gemischt**, Sättigung **gedeckt**, Dichte **ausgewogen**, Layout **gemischt**, Bewegung **ruhig**.
...
| `akzent` | `#c48227` | Handlung – ausschließlich Knöpfe und aktive Zustände (max. 8 % Fläche) | Primärknopf, Fokusring, aktive Rubrik |
| `akzentTief` | `#bf7f26` | Hover/gedrückt des Primärknopfs | Primärknopf :hover |
| `aufAkzent` | `#2d2519` | Schrift auf Akzentfläche | Primärknopf-Beschriftung |
| `akzentText` | `#95631e` | Akzent als Schrift – Links, Rubriken, Preise | Links, Rubrik, Plus-Knopf |
...
| `tint` | `#2c1e0d` | Dunkle Tafel – Hero-Tafel, Fußzeile, Overlay | Hero-Tafel, Fußzeile |
| `aufTint` | `#fefdfb` | Schrift auf der Tafel | Hero-Tafel, Fußzeile |
| `aufTintLeise` | `#c3bfb8` | Nebenschrift auf der Tafel | Fußzeilen-Links |
...
| aufTint | tint | 15.91:1 | 4.5:1 |
| aufTintLeise | tint | 8.83:1 | 4.5:1 |
| signalAufTint | tint | 7.10:1 | 4.5:1 |
...
| akzent | grund | 3.09:1 | 3:1 |

Herleitung: Neutrale warm getönt (#fdfbf7 → #fdfbf7), weil die Referenzen mehrheitlich warm sind. Akzent gedämpft (#c87f1e → #c07e27, Sättigung ×0.9), Referenzen sind gedeckt. Akzent 20 % Richtung Referenz-Akzent #faae33 gezogen (#c07e27 → #cc8829). Akzent für lesbare Knopfschrift und 3:1 gegen den Grund verschoben (#cc8829 → #c48227).

## Typografie

- **Anzeige:** Fjalla One 400, Versalien – schmale Plakatgrotesk – Bombay-Café-Schild
...
Herleitung: 2 von 3 ausgewerteten Referenzen führen ebenfalls mit schmaler Grotesk (serif, grotesk, grotesk).
...
- Schatten: papier (`0 1px 0 #eae0cf, 0 16px 32px -24px rgba(44,30,13,.35)`)
...
- Farbstimmung: hell, luftig; Akzent #c87f1e darf im Bild vorkommen (Serviette, Keramik), sonst warme Neutrale
...
- Prompt-Basis: `editorial restaurant photography, soft window side light, late morning, warm 3800K, open soft shadows, 45-degree table angle, cropped at the plate edge, staff hands allowed in frame, brass thali, copper kadai, spices in small bowls, naan on cotton cloth, light airy palette, natural imperfections, real restaurant setting, 35mm film look, no text, no people facing camera`
