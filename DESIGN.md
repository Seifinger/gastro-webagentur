...
4. Stage 5: dieselben Tokens auf das Nutzer-Dashboard (`dashboardServer.js`, `public/dashboard.html`, `public/bearbeiten.html`) übertragen – noch offen.
5. Jede Preset-/Stimmungs-Änderung weiterhin hier dokumentieren, bevor sie in Code übersetzt wird.
